        ...
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdown01">
                    ...
                    <a class="dropdown-item" href="/contact/Eric">Eric</a>
                    <a class="dropdown-item" href="/contact/Melanie">Melanie</a>
                    <a class="dropdown-item" href="/contact/Christophe">Christophe</a>
                    <a class="dropdown-item" href="/contact/Cédric">Cedric</a>
                </div>
            </li>
            <li class="nav-item">
